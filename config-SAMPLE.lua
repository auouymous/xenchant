...
xenchant.register_enchant("jump", "Jump Boost", xenchant.help.jump, 0, 0.5, xenchant.action.jump, 1, 3)
xenchant.register_enchant("jump2", "Jump Boost II", xenchant.help.jump, -0.75, 0.5, xenchant.action.jump, 2, 9)

xenchant.register_enchant("speed", "Speed Boost", xenchant.help.speed, 1, 1, xenchant.action.speed, 1, 3)
xenchant.register_enchant("speed2", "Speed Boost II", xenchant.help.speed, 1, 2, xenchant.action.speed, 2, 9)
